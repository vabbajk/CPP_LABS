...
// Конструктор с явным ID (для загрузки из БД)
...
void IncomeTransaction::print(){
    std::cout << "����� � " << name << " " << date << ", �����: " << amount
              << ", ��������� " << category << ", �������� ������ - " << incomeSource << std::endl;
}
...
void Expense::print(){
    std::cout << "Транзакция " << name << " " << date << ", �����: " << amount
              << ", ��������� " << category << ", ����� ����� - " << where << std::endl;
}
