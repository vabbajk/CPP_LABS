...
void clear_string(String &my_string) { my_string.clear(); }
...
void copy_string(const String &src, String &dest) { dest = src; }
...
void clear_temp_string(String &temp_string) { temp_string.clear(); }
